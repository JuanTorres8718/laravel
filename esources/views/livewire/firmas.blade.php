                                    ...
                                    <tr class="bg-gray-200">
                                        ...
                                        <td>
                                            <div class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">
                                                {{--  <!-- <img src="./img{{$imagen_firma}}"> -->  --}}
                                                {{--  @if ($filename== $f->imagen_firma)
                                                  <span
                                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full text-black text-center">
                                                 {{--  {{$f->imagen_firma}}  --}}
                                                 {{--  /image/{{ $product->image }}  --}}
                                                  {{--  C:\repositorio2_1\public\storage\files\8NvArQryrnUpllM7hqGxxtSEKnpu4thjRFnAEM4P.jpg  
                                                  </span>   
                                                @endif  --}}

                                                
                                                {{-- <img src="{{$f->imagen_firma}}" alt=""> --}}
                                                {{--  <img src="./resources/img.jpg" alt="">  --}}
                                                {{-- C:\repositorio2_1\storage\app\public\photos\ug5jWtx3KllUpuIfF5oQeSHXjFEXF9qfkPjYJAJW.jpg --}} 
